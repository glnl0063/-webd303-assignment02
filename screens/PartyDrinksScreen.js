...
/* PARTY DRINKS SCREEN */ 
export default class PartyDrinkScreen extends Component {
    ...
    componentDidMount() {
      ...
      // fetch data from cocktail database api and filter to show only drinks from punch/party drinks category 
      // take response anad parse body text to json
      // set json to datasource variable
      // if there is an error, console log the error      
      fetch("https://the-cocktail-db.p.rapidapi.com/filter.php?c=Punch%20/%20Party%20Drink", {
        method: "GET",
        headers: {
