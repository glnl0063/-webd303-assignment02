...
/* COCOA SCREEN */ 
export default class CocoaScreen extends Component {
    ...
    componentDidMount() {
      ...
      // fetch data from cocktail database api and filter to show only drinks from cocoa category 
      // take response anad parse body text to json
      // set json to datasource variable
      // if there is an error, console log the error      
      fetch("https://the-cocktail-db.p.rapidapi.com/filter.php?c=Cocoa", {
        method: "GET",
        headers: {
            ...
            renderItem={({item, index}) =>
              ...
              <Animatable.View animation="fadeInUp" delay={100 * index} useNativeDriver={true}>
                <BeverageCard 
                  ...
                  handlerReference={this.handleViewRef}
                />              
              </Animatable.View>            
